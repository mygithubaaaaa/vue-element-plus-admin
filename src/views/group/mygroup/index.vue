<template>
  <div class="app-container">
    ...
    <el-form :inline="true" :model="queryForm">
      ...
      <el-form-item>
        <el-button type="primary" @click="createButton" >创建组织</el-button>
      </el-form-item>
    </el-form>
    <!--    已发送通知表-->
    <el-table
...
<script>
import { createNotice, readInfo, sendNotice, updateNotice } from '@/api/notice'
import { getMyGroup, queryGroup } from '@/api/groupUser'
